<?php
	...
	{
		$inqry="insert into tbl_complainttype(type_name)values('".$_POST["txtcomplainttype"]."')";
		mysql_query($inqry);
	}
    if(isset($_GET["delID"]))
	{
		$delQry="delete from tbl_complainttype where complaint_typeid='".$_GET["delID"]."'";
		mysql_query($delQry);
...
<title>LoadSwift::Complaint</title>
</head>
...
<table border="1" align="center">
    ...
    <tr>
            ...
            <td><a href="ComplaintType.php?delID=<?php echo $row["complaint_typeid"]?>">Delete</a></td>
	</tr>
    <?php
			}
	?>
