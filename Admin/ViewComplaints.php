...
<div class="container">
    ...
    <div class="text-center">
        <table class="table table-bordered" style="width: 533px;">
            ...
            <?php
            $selqry="select * from tbl_complaint c inner join tbl_seller s on c.seller_id=s.seller_id where complaint_status='0'";
             $data=mysql_query($selqry);
            $i=0;
            while($row=mysql_fetch_array($data))
            {
    ...
    <div class="text-center">
        <table class="table table-bordered" style="width: 533px;">
            ...
            <?php
             $selqry="select * from tbl_complaint c inner join tbl_agent s on c.agent_id=s.agent_id where complaint_status='0'";
             $data=mysql_query($selqry);
            $i=0;
            while($row=mysql_fetch_array($data))
            {
    ...
    <div class="text-center">
        <table class="table table-bordered" style="width: 533px;">
            ...
            <?php
             $selqry="select * from tbl_complaint c inner join tbl_lorryowner s on c.lorryowner_id=s.lorryowner_id where complaint_status='0'";
             $data=mysql_query($selqry);
            $i=0;
            while($row=mysql_fetch_array($data))
            {
