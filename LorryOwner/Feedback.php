<?php
	...
	{
		$inqry="insert into tbl_feedback(lorryowner_id,feedback_content)values('".$_SESSION["lorryownerid"]."','".$_POST["txtcontent"]."')";
		mysql_query($inqry);
	}
    if(isset($_GET["delID"]))
	{
...
<table border="1" align="center">
    ...
    <tr>
            ...
            <td><a href="Feedback.php?delID=<?php echo $row["feedback_id"]?>">Delete</a></td>
	</tr>
    <?php
			}
	?>
