...
If(isset($_POST["btn_sub"]))
{
	...
	$insqry="insert into tbl_complaint(complainttype_id,complaint_content,agent_id,complaint_date) values('".$complaint_type."','".$complaintcontent."','".$_SESSION['agentid']."',curdate())";
...
$selqry="select * from tbl_complaint c inner join tbl_booking b on b.booking_id = c.booking_id 
    inner join tbl_cart ca on ca.booking_id=b.booking_id inner join tbl_complainttype t on c.complainttype_id=t.complainttype_id where c.agent_id=".$_SESSION['agentid'];
