...
if (isset($_GET["aID"])) {
    ...
    header("location:ViewMoreAgent.php");
}
?>
<!doctype html>
<html lang="en">
<head>
    ...
    <title>LoadSwift: Search Agent</title>
    ...
    <style>
        ...
        * {
        ...
        h1 {
            color: #00796b;
            text-align: center;
             margin: 40px 0 100px; /* Allows the heading to take available space */
        }
...
<body>
    ...
    <div class="content">
        ...
        <form id="form1" name="form1" method="post" enctype="multipart/form-data">
            ...
            <table>
                    ...
                    <tr>
                        <td>Place</td>
                        <td>
                            <select name="selplace" id="selplace" onchange="getAgentList(this.value)">
                                <option value="">----select----</option>
                            </select>
                        </td>
                    </tr>
        ...
        <div id="agentList">
            <!-- The list of agents will be loaded here via AJAX -->
        </div>
    </div>
...
//         function Assign(aid) {
//     $.ajax({
//         url: "../Asset/AjaxPages/AjaxAssign.php",
//         method: "GET",
//         data: { aid: aid },
//         success: function (result) {
...
// }
       ...
       function Assign(aid)
            {
                $.ajax({
                    url: "../Asset/AjaxPages/AjaxAssign.php?aid=" + aid,
        ...
        function getAgentList(place_id) {
           
            $.ajax({
                url: "../Asset/AjaxPages/AjaxAgentList.php",
                method: "GET",
