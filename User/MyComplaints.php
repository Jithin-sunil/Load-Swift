...
include("../Asset/Connection/Connection.php");
  include("Head.php");                                     
    ...
    inner join tbl_cart ca on ca.booking_id=b.booking_id inner join tbl_complainttype t on c.complaint_typeid=t.complaint_typeid where c.user_id=".$_SESSION['userid'];
