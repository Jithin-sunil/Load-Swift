...
If(isset($_POST["btn_sub"]))
{
	...
	$insqry="insert into tbl_complaint(complaint_type,complaint_content,user_id,booking_id,complaint_date) values('".$complaint_type."','".$complaintcontent."','".$_SESSION['userid']."','".$_GET['bid']."',curdate())";
    ...
    <table width="200" border="1">
      <tr>
        ...
        <td> <select name="sel_type" id="">
            ...
            {
                ?>
            <option value="<?php echo $row['complaint_typeid'];?>"><?php echo $row['type_name'];?></option>
            <?php
            }
            ?>
        </select>
